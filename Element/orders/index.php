...
if ($activeTab === 'orders' && isset($_GET['page'])) {
        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2">
                <?php if ($currentPage > 1): ?>
                    <a href="?tab=orders&page=<?php echo $currentPage - 1; ?>" class="px-3 py-1 bg-gray-700 text-white rounded hover:bg-gray-600">Trước</a>
                <?php else: ?>
                ...
                <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                    ...
                    <?php else: ?>
                        <a href="?tab=orders&page=<?php echo $i; ?>" class="px-3 py-1 bg-gray-700 text-white rounded hover:bg-gray-600"><?php echo $i; ?></a>
                    <?php endif; ?>
                <?php endfor; ?>
                
                <?php if ($currentPage < $totalPages): ?>
                    <a href="?tab=orders&page=<?php echo $currentPage + 1; ?>" class="px-3 py-1 bg-gray-700 text-white rounded hover:bg-gray-600">Sau</a>
                <?php else: ?>
