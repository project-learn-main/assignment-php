            ...
            <div class="p-6">
                        ...
                        <div class="relative my-6">
                            ...
                            <div class="relative flex justify-center text-sm">
                                <span class="px-4 bg-gray-800 text-gray-400">Don't have an account?</span>
                            </div>
                        </div>

                        <!-- Sign Up Link -->
                        <a href="signup.php" class="block w-full text-center border border-gray-600 text-gray-300 hover:bg-gray-700 hover:text-white hover:border-gray-500 font-medium py-3 px-4 rounded-lg transition-all transform hover:-translate-y-0.5">
                            Create Account
                        </a>
                    </div>
                </div>
